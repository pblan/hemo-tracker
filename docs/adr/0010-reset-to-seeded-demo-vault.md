...
staging directory with a new account key set and recovery code. It validates the
...
non-vault application preferences. Show the new recovery code once and require
...
- Fresh recovery material must be stored after every reset.
