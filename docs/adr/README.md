...
The accepted records explain decisions that constrain the Hemo Tracker architecture.

- [ADR 0001: Use a trusted desktop client and an opaque server](0001-use-a-trusted-desktop-client-and-an-opaque-server.md)
