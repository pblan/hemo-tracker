...
Add path-filtered documentation checks for links, Markdown rules, and Mermaid syntax. Do not add screenshot rendering to routine source-code CI. Add screenshot freshness and manual visual review to the V1 release gate.
